...
namespace Bblioteca.Controllers
{
    ...
    {
        private readonly BbliotecaContext _context;

        public LivroesController(BbliotecaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Autor,Area,Ano,Editora")] Livro livro)
        {
